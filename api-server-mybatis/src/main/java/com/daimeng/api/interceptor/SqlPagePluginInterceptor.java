...
import com.daimeng.api.utils.ReflectHelper;
import com.github.pagehelper.Page;

/**
 * 已使用com.github.pagehelper.PageInterceptor，本类已无需
 * @author daimeng
 *
 */
@Intercepts({ @Signature(type = StatementHandler.class, method = "prepare", args = { Connection.class, Integer.class }) })
public class SqlPagePluginInterceptor implements Interceptor{
	...
	public Object intercept(Invocation paramInvocation) throws Throwable {
		if(paramInvocation.getTarget() instanceof RoutingStatementHandler){
			RoutingStatementHandler statementHandler = (RoutingStatementHandler)paramInvocation.getTarget();
	...
	private String generatePageSql(String sql,Page page){
		if(page!=null && dialect != null && !"".equals(dialect)){
			...
			if("mysql".equals(dialect)){
				...
				pageSql.append(page.getPageNum()+page.getPageSize());
				pageSql.append(") where row_id>");
				pageSql.append(page.getPageNum());
			}
	...
	//拦截器只有 plugin方法执行了，intercept方法没有执行
	@Override
