...
public class WordPoiTools {
	 ...
	 * 调用替换柱状图数据
	 */
	public static XWPFChart replaceBarCharts(POIXMLDocumentPart poixmlDocumentPart,
		...
		// 刷新内置excel数据
		refreshExcel(chart, listItemsByType, fldNameArr,
				titleArr);
		// 刷新页面显示数据
		refreshBarStrGraphContent(barChart, BarSerList, listItemsByType,
				fldNameArr, 1);
		return chart;
	}
	...
	public static void replaceLineCharts(POIXMLDocumentPart poixmlDocumentPart,
		...
		refreshExcel(chart, listItemsByType, fldNameArr,
				titleArr);
		// 刷新页面显示数据
		refreshLineStrGraphContent(lineChart, lineSerList,
				listItemsByType, fldNameArr, 1);
	...
	public static void replacePieCharts(POIXMLDocumentPart poixmlDocumentPart,
		...
		refreshExcel(chart, listItemsByType, fldNameArr,
				titleArr);
		// 刷新页面显示数据
		refreshPieStrGraphContent(pieChart, pieSerList,
				listItemsByType, fldNameArr, 1);
	 ...
	 * 调用替换柱状图、折线图组合数据
	 */
	public static void replaceCombinationCharts(
			POIXMLDocumentPart poixmlDocumentPart, List<String> titleArr,
	 ...
	 * @param content
	 */
	public static void setWordCellSelfStyle(XWPFTableCell cell,
